...
export const noticeCreateMutation = gql`mutation CreateNotice($title: String!, $body: String!, $status: Int!, 
...
export const noticeStatusMutation = gql`mutation StatusNotice($id: ID!, $input: {$status: Int!}){
